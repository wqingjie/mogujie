~function (){
    ...
    function move(curEle,target,duration,effect,callback){ //���Ǹ�Ԫ���˶�
        ...
        }else if(typeof effect == 'function'){ //�������ص�����
            callback = effect;
        }
        ...
        curEle.zhufengTimer = window.setInterval(function (){
            ...
            if(time >= duration){ //����Ŀ��
                ...
                typeof callback == 'function' && callback.call(curEle); //�ص������ж�
                return;
            }
            //û����Ŀ��,�ֱ��ȡÿ������Ȼ��������
            for(var key in target){
                if(target.hasOwnProperty(key)){
                    var val = tempEffect(time,begin[key],change[key],duration);
                    utils.setCss(curEle,key,val);
                }
            }
        },interval);
    }
    //������return���س�����һ�����󣬻���ֱ�Ӹ�ֵ��window
